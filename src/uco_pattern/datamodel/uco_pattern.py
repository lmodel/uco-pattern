# Auto generated from uco_pattern.yaml by pythongen.py version: 0.9.0
# Generation date: 2023-04-12T12:14:36
# Schema: ucolink-pattern
#
...
class StringType(String):
    ...
    type_model_uri = PATTERN.StringType
...
class LiteralType(String):
    ...
    type_model_uri = PATTERN.LiteralType
...
class NonNegativeIntegerType(Integer):
    ...
    type_model_uri = PATTERN.NonNegativeIntegerType
...
class StatementType(StringType):
    ...
    type_model_uri = PATTERN.StatementType
...
class IriType(Uriorcurie):
    ...
    type_name = "iri type"
    type_model_uri = PATTERN.IriType
...
class BooleanType(Boolean):
    ...
    type_model_uri = PATTERN.BooleanType
...
class HexBinaryType(hex):
    ...
    type_model_uri = PATTERN.HexBinaryType
...
class UcoThing(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = PATTERN.UcoThing
...
class UcoInherentCharacterizationThing(UcoThing):
    ...
    class_model_uri: ClassVar[URIRef] = PATTERN.UcoInherentCharacterizationThing
...
class PatternExpression(UcoInherentCharacterizationThing):
    ...
    class_model_uri: ClassVar[URIRef] = PATTERN.PatternExpression
...
class ExternalReference(UcoInherentCharacterizationThing):
    ...
    class_model_uri: ClassVar[URIRef] = PATTERN.ExternalReference
...
class Facet(UcoInherentCharacterizationThing):
    ...
    class_model_uri: ClassVar[URIRef] = PATTERN.Facet
...
class ConfidenceFacet(Facet):
    ...
    class_model_uri: ClassVar[URIRef] = PATTERN.ConfidenceFacet
...
class UcoObject(UcoThing):
    ...
    class_model_uri: ClassVar[URIRef] = PATTERN.UcoObject
...
class Pattern(UcoObject):
    ...
    class_model_uri: ClassVar[URIRef] = PATTERN.Pattern
...
class LogicalPattern(Pattern):
    ...
    class_model_uri: ClassVar[URIRef] = PATTERN.LogicalPattern
...
class Assertion(UcoObject):
    ...
    class_model_uri: ClassVar[URIRef] = PATTERN.Assertion
...
class Annotation(Assertion):
    ...
    class_model_uri: ClassVar[URIRef] = PATTERN.Annotation
...
class AttributedName(UcoObject):
    ...
    class_model_uri: ClassVar[URIRef] = PATTERN.AttributedName
...
class Compilation(UcoObject):
    ...
    class_model_uri: ClassVar[URIRef] = PATTERN.Compilation
...
class ContextualCompilation(Compilation):
    ...
    class_model_uri: ClassVar[URIRef] = PATTERN.ContextualCompilation
...
class ControlledVocabulary(UcoObject):
    ...
    class_model_uri: ClassVar[URIRef] = PATTERN.ControlledVocabulary
...
class EnclosingCompilation(Compilation):
    ...
    class_model_uri: ClassVar[URIRef] = PATTERN.EnclosingCompilation
...
class Bundle(EnclosingCompilation):
    ...
    class_model_uri: ClassVar[URIRef] = PATTERN.Bundle
...
class Grouping(ContextualCompilation):
    ...
    class_model_uri: ClassVar[URIRef] = PATTERN.Grouping
...
class IdentityAbstraction(UcoObject):
    ...
    class_model_uri: ClassVar[URIRef] = PATTERN.IdentityAbstraction
...
class Item(UcoObject):
    ...
    class_model_uri: ClassVar[URIRef] = PATTERN.Item
...
class MarkingDefinitionAbstraction(UcoObject):
    ...
    class_model_uri: ClassVar[URIRef] = PATTERN.MarkingDefinitionAbstraction
...
class ModusOperandi(UcoObject):
    ...
    class_model_uri: ClassVar[URIRef] = PATTERN.ModusOperandi
...
class Relationship(UcoObject):
    ...
    class_model_uri: ClassVar[URIRef] = PATTERN.Relationship
...
slots.patternExpression = Slot(uri=PATTERN.patternExpression, name="patternExpression", curie=PATTERN.curie('patternExpression'),
                   model_uri=PATTERN.patternExpression, domain=None, range=Optional[str])

slots.confidence = Slot(uri=CORE.confidence, name="confidence", curie=CORE.curie('confidence'),
                   model_uri=PATTERN.confidence, domain=None, range=Optional[Union[int, NonNegativeIntegerType]])
...
slots.constrainingVocabularyName = Slot(uri=CORE.constrainingVocabularyName, name="constrainingVocabularyName", curie=CORE.curie('constrainingVocabularyName'),
                   model_uri=PATTERN.constrainingVocabularyName, domain=None, range=Optional[str])
...
slots.LogicalPattern_patternExpression = Slot(uri=PATTERN.patternExpression, name="LogicalPattern_patternExpression", curie=PATTERN.curie('patternExpression'),
                   model_uri=PATTERN.LogicalPattern_patternExpression, domain=LogicalPattern, range=Optional[str])

slots.Annotation_object = Slot(uri=CORE.object, name="Annotation_object", curie=CORE.curie('object'),
                   model_uri=PATTERN.Annotation_object, domain=Annotation, range=Union[Union[dict, "UcoObject"], List[Union[dict, "UcoObject"]]])

slots.Assertion_statement = Slot(uri=CORE.statement, name="Assertion_statement", curie=CORE.curie('statement'),
                   model_uri=PATTERN.Assertion_statement, domain=Assertion, range=Optional[Union[str, List[str]]])
...
slots.AttributedName_namingAuthority = Slot(uri=CORE.namingAuthority, name="AttributedName_namingAuthority", curie=CORE.curie('namingAuthority'),
                   model_uri=PATTERN.AttributedName_namingAuthority, domain=AttributedName, range=Optional[str])

slots.ConfidenceFacet_confidence = Slot(uri=CORE.confidence, name="ConfidenceFacet_confidence", curie=CORE.curie('confidence'),
                   model_uri=PATTERN.ConfidenceFacet_confidence, domain=ConfidenceFacet, range=Union[int, NonNegativeIntegerType])

slots.ContextualCompilation_object = Slot(uri=CORE.object, name="ContextualCompilation_object", curie=CORE.curie('object'),
                   model_uri=PATTERN.ContextualCompilation_object, domain=ContextualCompilation, range=Union[Union[dict, "UcoObject"], List[Union[dict, "UcoObject"]]])
...
slots.ControlledVocabulary_constrainingVocabularyReference = Slot(uri=CORE.constrainingVocabularyReference, name="ControlledVocabulary_constrainingVocabularyReference", curie=CORE.curie('constrainingVocabularyReference'),
                   model_uri=PATTERN.ControlledVocabulary_constrainingVocabularyReference, domain=ControlledVocabulary, range=Optional[Union[str, IriType]])
...
slots.ControlledVocabulary_constrainingVocabularyName = Slot(uri=CORE.constrainingVocabularyName, name="ControlledVocabulary_constrainingVocabularyName", curie=CORE.curie('constrainingVocabularyName'),
                   model_uri=PATTERN.ControlledVocabulary_constrainingVocabularyName, domain=ControlledVocabulary, range=Optional[str])

slots.ControlledVocabulary_value = Slot(uri=CORE.value, name="ControlledVocabulary_value", curie=CORE.curie('value'),
                   model_uri=PATTERN.ControlledVocabulary_value, domain=ControlledVocabulary, range=str)

slots.EnclosingCompilation_object = Slot(uri=CORE.object, name="EnclosingCompilation_object", curie=CORE.curie('object'),
                   model_uri=PATTERN.EnclosingCompilation_object, domain=EnclosingCompilation, range=Optional[Union[Union[dict, "UcoObject"], List[Union[dict, "UcoObject"]]]])
...
slots.ExternalReference_referenceURL = Slot(uri=CORE.referenceURL, name="ExternalReference_referenceURL", curie=CORE.curie('referenceURL'),
                   model_uri=PATTERN.ExternalReference_referenceURL, domain=ExternalReference, range=Optional[Union[str, IriType]])
...
slots.ExternalReference_definingContext = Slot(uri=CORE.definingContext, name="ExternalReference_definingContext", curie=CORE.curie('definingContext'),
                   model_uri=PATTERN.ExternalReference_definingContext, domain=ExternalReference, range=Optional[str])
...
slots.ExternalReference_externalIdentifier = Slot(uri=CORE.externalIdentifier, name="ExternalReference_externalIdentifier", curie=CORE.curie('externalIdentifier'),
                   model_uri=PATTERN.ExternalReference_externalIdentifier, domain=ExternalReference, range=Optional[str])

slots.Grouping_context = Slot(uri=CORE.context, name="Grouping_context", curie=CORE.curie('context'),
                   model_uri=PATTERN.Grouping_context, domain=Grouping, range=Optional[Union[str, List[str]]])

slots.Relationship_endTime = Slot(uri=CORE.endTime, name="Relationship_endTime", curie=CORE.curie('endTime'),
                   model_uri=PATTERN.Relationship_endTime, domain=Relationship, range=Optional[Union[Union[str, XSDDateTime], List[Union[str, XSDDateTime]]]])
...
slots.Relationship_isDirectional = Slot(uri=CORE.isDirectional, name="Relationship_isDirectional", curie=CORE.curie('isDirectional'),
                   model_uri=PATTERN.Relationship_isDirectional, domain=Relationship, range=Union[bool, BooleanType])
...
slots.Relationship_kindOfRelationship = Slot(uri=CORE.kindOfRelationship, name="Relationship_kindOfRelationship", curie=CORE.curie('kindOfRelationship'),
                   model_uri=PATTERN.Relationship_kindOfRelationship, domain=Relationship, range=Optional[str])

slots.Relationship_target = Slot(uri=CORE.target, name="Relationship_target", curie=CORE.curie('target'),
                   model_uri=PATTERN.Relationship_target, domain=Relationship, range=Union[dict, "UcoObject"])

slots.Relationship_source = Slot(uri=CORE.source, name="Relationship_source", curie=CORE.curie('source'),
                   model_uri=PATTERN.Relationship_source, domain=Relationship, range=Union[Union[dict, "UcoObject"], List[Union[dict, "UcoObject"]]])

slots.Relationship_startTime = Slot(uri=CORE.startTime, name="Relationship_startTime", curie=CORE.curie('startTime'),
                   model_uri=PATTERN.Relationship_startTime, domain=Relationship, range=Optional[Union[Union[str, XSDDateTime], List[Union[str, XSDDateTime]]]])

slots.UcoObject_description = Slot(uri=DCTERMS.description, name="UcoObject_description", curie=DCTERMS.curie('description'),
                   model_uri=PATTERN.UcoObject_description, domain=UcoObject, range=Optional[Union[str, List[str]]])

slots.UcoObject_createdBy = Slot(uri=CORE.createdBy, name="UcoObject_createdBy", curie=CORE.curie('createdBy'),
                   model_uri=PATTERN.UcoObject_createdBy, domain=UcoObject, range=Optional[str])
...
slots.UcoObject_externalReference = Slot(uri=CORE.externalReference, name="UcoObject_externalReference", curie=CORE.curie('externalReference'),
                   model_uri=PATTERN.UcoObject_externalReference, domain=UcoObject, range=Optional[Union[str, List[str]]])

slots.UcoObject_hasFacet = Slot(uri=CORE.hasFacet, name="UcoObject_hasFacet", curie=CORE.curie('hasFacet'),
                   model_uri=PATTERN.UcoObject_hasFacet, domain=UcoObject, range=Optional[Union[str, List[str]]])

slots.UcoObject_modifiedTime = Slot(uri=CORE.modifiedTime, name="UcoObject_modifiedTime", curie=CORE.curie('modifiedTime'),
                   model_uri=PATTERN.UcoObject_modifiedTime, domain=UcoObject, range=Optional[Union[Union[str, XSDDateTime], List[Union[str, XSDDateTime]]]])

slots.UcoObject_name = Slot(uri=RDFS.label, name="UcoObject_name", curie=RDFS.curie('label'),
                   model_uri=PATTERN.UcoObject_name, domain=UcoObject, range=Optional[str])
...
slots.UcoObject_objectCreatedTime = Slot(uri=CORE.objectCreatedTime, name="UcoObject_objectCreatedTime", curie=CORE.curie('objectCreatedTime'),
                   model_uri=PATTERN.UcoObject_objectCreatedTime, domain=UcoObject, range=Optional[Union[str, XSDDateTime]])

slots.UcoObject_objectMarking = Slot(uri=CORE.objectMarking, name="UcoObject_objectMarking", curie=CORE.curie('objectMarking'),
                   model_uri=PATTERN.UcoObject_objectMarking, domain=UcoObject, range=Optional[Union[Union[dict, MarkingDefinitionAbstraction], List[Union[dict, MarkingDefinitionAbstraction]]]])

slots.UcoObject_specVersion = Slot(uri=CORE.specVersion, name="UcoObject_specVersion", curie=CORE.curie('specVersion'),
                   model_uri=PATTERN.UcoObject_specVersion, domain=UcoObject, range=Optional[str])

slots.UcoObject_tag = Slot(uri=CORE.tag, name="UcoObject_tag", curie=CORE.curie('tag'),
                   model_uri=PATTERN.UcoObject_tag, domain=UcoObject, range=Optional[Union[str, List[str]]])